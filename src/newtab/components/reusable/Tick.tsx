...
export default function Tick(props: {
  ...
  return completed ? (
    <div
      className="m-1 flex aspect-square h-[2em] justify-center"
      onClick={() => changeTickState()}>
      <svg viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M5.87498 10.175L2.19998 6.49999L0.974976 7.72499L5.87498 12.625L16.375 2.12499L15.15 0.899994L5.87498 10.175Z"
          fill="white"
        />
      </svg>
    </div>
