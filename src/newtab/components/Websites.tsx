...
export default function Websites() {
  ...
  return (
    <div className="min-h-[150px] aspect-video w-full bg-black flex flex-col px-5 py-3 rounded-lg break-normal text-slate-200 gap-1 text-center overflow-y-auto">
      {domains}
    </div>
  )
}