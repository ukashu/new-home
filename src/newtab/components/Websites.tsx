...
export default function Websites() {
  ...
  return (
    <div className="min-h-[150px] aspect-video w-full bg-black flex flex-col p-2 rounded-lg break-normal text-slate-200 gap-1 text-center justify-between overflow-y-auto">
      <h2>WEBSITES</h2>
      {domains}
    </div>
  )
